...
dataSource.products = {
  ...
  pizza: {
    ...
    images: [
      ...
      '<img class="sauce-tomato" src="images/pizza/tomato-sauce.svg">', //poniższe klasy składają się z dwóch członów - pierwszy - klucz parametru, drugi - to klucz opcji, obrazki mają mieć usuniętą klasę active, bo będzie ona nadawana przez kod JS, tylko tym obrazków, dla których opcje zostały zaznaczone
